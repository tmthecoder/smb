...
//! - [`message`]: The [`SMBMessage`](message::SMBMessage) wrapper that pairs a header with a body,
//!   plus serialization, parsing, and cryptographic signing.

/// SMB2 message body types for all command request/response pairs.
pub mod body;
/// SMB2 Packet Header types (Sync/Async/Legacy), command codes, flags, and NT status.
pub mod header;
/// SMB2 message framing: combines header + body, handles serialization and signing.
pub mod message;