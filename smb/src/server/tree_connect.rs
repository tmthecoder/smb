...
impl<S: Server> SMBTreeConnect<S> {
    ...
    fn build_file_standard_info(open: &S::Open) -> SMBResult<Vec<u8>> {
        ...
        buf.push(
            if open.file_attributes().contains(
                crate::protocol::body::create::file_attributes::SMBFileAttributes::DIRECTORY,
            ) {
                1
            } else {
                0
    ...
    fn build_file_all_info(open: &S::Open) -> SMBResult<Vec<u8>> {
        ...
        let is_dir = open
            .file_attributes()
            .contains(crate::protocol::body::create::file_attributes::SMBFileAttributes::DIRECTORY);
